<?php
session_start();
define("ADMINURL", "http://localhost:3000/admin-panel");
?>
<!DOCTYPE html>
<html lang="en">
                ...
                <div class="collapse navbar-collapse" id="navbarText">
                    <?php if (isset($_SESSION['admin_name'])) : ?>
                        <ul class="navbar-nav side-nav">
                            <li class="nav-item">
                                <a class="nav-link" style="margin-left: 20px;" href="<?php echo ADMINURL; ?>/admin.php ">Home
                    ...
                    <ul class="navbar-nav ml-md-auto d-md-flex">
                        <?php if (isset($_SESSION['admin_name'])) : ?>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo ADMINURL; ?>/admin.php">Home
                                <span class="sr-only">(current)</span>
                            </a>
                        </li>
